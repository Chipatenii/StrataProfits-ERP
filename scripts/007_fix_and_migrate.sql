-- Fix and Migrate Script
-- This script first ensures the 'assigned_to' column exists, then applies the enhancements.

-- 1. Fix: Ensure assigned_to column exists
DO $$
BEGIN
...
-- 2. Apply Enhanced Features (Same as before)
