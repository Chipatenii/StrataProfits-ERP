        ...
        <div className="flex bg-white rounded-lg p-1 border border-border w-fit mb-6">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${
              activeView === "my-day" ? "bg-accent text-white" : "text-muted-foreground hover:text-foreground"
            }`}
          >
          ...
          {profile?.role === "virtual_assistant" && (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                activeView === "pipeline" ? "bg-accent text-white" : "text-muted-foreground hover:text-foreground"
              }`}
            >
