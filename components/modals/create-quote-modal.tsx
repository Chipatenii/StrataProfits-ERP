        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 mt-2">
                    ...
                    <div className="space-y-6 p-4 bg-card/50 rounded-lg border border-border/50">
                        ...
                        {items.map((item, index) => (
                            <div key={item.id} className="grid grid-cols-12 gap-2 items-start py-2 border-b border-border/50 group hover:bg-muted/50 rounded-lg px-2 transition-colors">
                                ...
                                <div className="col-span-1 pt-2 text-right font-medium text-sm flex justify-between">
                                    ...
                                    <button type="button" onClick={() => removeItem(item.id)} className="text-muted-foreground hover:text-destructive ml-2">
                                        <Trash2 size={14} />
                                    </button>
                                </div>
                            </div>
